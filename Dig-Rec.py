    ...
    while (cap.isOpened()):
        ...
        if len(cnts) >= 1:
            ...
            if len(pts) != []:
                ...
                blackboard_cnts,heirs = cv2.findContours(thresh1.copy(), cv2.RETR_TREE, cv2.CHAIN_APPROX_NONE)
        ...
        cv2.putText(img, "MultiPreceptron Network: " + str(pred_ann)
                + " Score: " + str(score_ann), (10, 410),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
        cv2.putText(img, "Convolutional NeuralNet: " + str(pred_cnn) 
                + " Score: " + str(score_cnn) , (10, 440),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
        cv2.putText(img, "Recurrent NeuraNet: " + str(pred_rnn)
                + " Score: " + str(score_rnn), (10, 470),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
